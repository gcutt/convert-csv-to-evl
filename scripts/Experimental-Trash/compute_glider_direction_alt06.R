...
# 
# # --- One turning point per neutral run ---
...
#   if (s >= e) next
#   
#   # Extract depth segment
#   z_seg <- df[[depth_col]][s:e]
#   
#   # Determine if this is a bottom or top
...
#   
#   if (left_slope < 0) {
#     # descending into neutral zone → valley
#     idx <- which.min(z_seg)
#   } else {
#     # ascending into neutral zone → peak
#     idx <- which.max(z_seg)
#   }
#   
